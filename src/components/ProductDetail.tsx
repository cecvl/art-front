...
const sizes = [
  { key: 'mini', label: 'Mini', size: '12"x8"', price: 65 },
  { key: 'small', label: 'Small', size: '18"x12"', price: 75 },
  { key: 'medium', label: 'Medium', size: '26"x18"', price: 90 },
  { key: 'large', label: 'Large', size: '40"x26"', price: 105 },
];
...
export default function ProductDetail({ artItemId, onAddToCart, onNavigateToCart }: ProductDetailProps) {
  ...
  const currentPrice = sizes.find(s => s.key === selectedSize)?.price || 105;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <hr />
        {/* Single, correct section for Material selection */}
        ...
        {/* Only one section for size selection */}
        <div className="option-section">
        ...
        {/* Only one section for frame selection */}
        <div className="option-section">
        ...
        {/* Single price display, no discounts */}
